LoginLayout = React.createClass({
   authenticate(e) {
      ...
      let authenticator = new Shopify.PublicAppOAuthAuthenticator({
         shop: storeName, api_key: '2ee8520dfad4a03788455a613f39e5fb', keyset: 'default', scopes: 'all', // request all permissions
         onAuth: function(accessToken) {
            ...
            let api = new Shopify.API({shop: storeName, keyset: Session.get('visitUUID')});
